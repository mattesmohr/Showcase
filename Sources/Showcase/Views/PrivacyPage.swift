                    ...
                    HStack(alignment: .top, spacing: .large) {
                        VStack(spacing: .large) {
                            ...
                            VStack {
                                ...
                                Text {
                                    MarkdownString {
                                        "We are hosting the content of our website at IONOS SE, Elgendorfer Str. 57, 56410 Montabaur, Germany. Whenever you visit our website, IONOS records various logfiles along with your IP addresses. For details, please consult the [data privacy policy](https://www.ionos.de/terms-gtc/terms-privacy) of IONOS. We use IONOS on the basis of Art. 6 (1)(f) GDPR. Our company has a legitimate interest in presenting a website that is as dependable as possible. If appropriate consent has been obtained, the processing is carried out exclusively on the basis of Art. 6(1)(a) GDPR and § 25 (1) TTDSG, insofar the consent includes the storage of cookies or the access to information in the user’s end device (e.g., device fingerprinting) within the meaning of the TTDSG. This consent can be revoked at any time."
                                    }
                                }
                                .fontSize(.medium)
                            }
                            ...
                            VStack {
                                ...
                                .fontSize(.medium)
                                Text {
                                    "Matthias Mohr, Hellerstr. 7, 96047 Bamberg, Deutschland"
                                }
                                .fontSize(.medium)
                                Text {
